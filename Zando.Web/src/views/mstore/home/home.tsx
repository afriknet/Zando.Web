...
export class HomePage extends jx.Views.ReactView {
...
export class InternalView extends jx.Views.ReactView {
...
class TopHeader extends jx.Views.ReactView {
...
class MiddleHeader extends jx.Views.ReactView {
                    ...
                    <div className="main-header">
                        <div className="row">
                            <div className="col-md-3 logo">
                                <a href="index.html"><img alt="Logo" src="/mstore/images/logo-blue.png" /></a>
                            </div>
...
class NavigationBar extends jx.Views.ReactView {
